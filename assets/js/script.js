(function ($) {
	...
	/*fabio
	$(".img-fluid-dark").css("height", $(".img-fluid").height());*/
	/*$("input+label").css("width", $(".img-fluid").width());*/ /*fabio*/
	/*$("input+label").css("height", $(".img-fluid").height()/3);fabio*/
	/*fabio*/
	...
	$('.botao-prev-fabio').on("click", function () { /*fabio*/
		backgroundSlide.trigger('prev.owl.carousel');
	});
